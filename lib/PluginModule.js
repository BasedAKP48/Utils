...
class Module extends EventEmitter {
   ...
   * @param {String} [options.dir] Path to working directory. Ignored if cidPath is present.
   * @param {String} [options.dirFile] Name of file to read CID from. Ignored if cidPath is present.
